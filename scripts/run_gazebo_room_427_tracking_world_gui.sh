...
SERVER_BACKEND="${GZ_SERVER_RENDER_BACKEND:-opengl}"
GUI_BACKEND="${GZ_RENDER_BACKEND:-opengl}"
SERVER_PID=""
...
echo "If the main 3D view is still blank on OpenGL, retry with:"
echo "  GZ_RENDER_BACKEND=metal ./scripts/run_gazebo_room_427_tracking_world_gui.sh"
echo
